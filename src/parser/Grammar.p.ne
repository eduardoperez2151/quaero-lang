...
key ->
  identifier                                                          {%  id  %}
  | string                                                            {%  id  %} ##Bruno:se deberia de poder?; Edu:Creo que no  ej lista=[1,2,3,x:4], lista["x"] es igual a lista.x pero no deberiamos llamar lista."x" esto no deberia ser asi, capaz me equivoco pero creo que no
